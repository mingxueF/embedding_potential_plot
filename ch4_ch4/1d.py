...
np.save(basis_str + '.npy',rho0_diff)
#rho0_diff = rho0_diff.reshape(cc.nx,cc.ny,cc.nz)
#cc.write(rho0_diff,'rho_diff_1D'+basis_str+'.cube','density difference between refHF') 
#-----------------------------------------------------------------------------
