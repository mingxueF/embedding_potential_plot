...
dmA_ref = np.load("dm0_ref"+basis_str+".npy")# hf from FnT
dmB = np.load("dm1_ref"+ basis_str +".npy") # hf from FnT
dmB_mp2 = np.load(os.path.join(root,'Dm/'+basis_str+'/dmB_mp2.npy'))
dmA_iso = np.load(os.path.join(root,'Dm/'+basis_str+'/dmA_iso.npy')) # mp2 
dmB_iso = np.load(os.path.join(root,'Dm/'+basis_str+'/dmB_iso.npy')) # mp2
dmAB_mp2 = np.load(os.path.join(root,'Dm/'+basis_str+'/dmAB_mp2.npy'))
# =============================================================================
